            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="passward" name="password" placeholder="Enter password"/> </div>

                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Confirm Password</h6>
                        </label> <input type="password" name="confirm password" placeholder="Enter confirm password"/> </div>
